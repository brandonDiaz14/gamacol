...
<body>
    <header>
       ...
       <section id="slogan"><h3>Lo mejor al mejor el precio</h3>
       </section>
    ...
    <main>
        ...
        <div id="publicidad"><h4>Vista rapida</h4>
            <figure style="height:250px;width:600px"><img src="ASEO gif.jpg"></figure>
        </div>

        <article><p style="text-align:center;">Productos mas vendidos (Aseo para el hogar)</p>
            <div class="tarjeta">
                <div class="imgbox"><img src="clorox morado.jpg"></div>
                <div class="details">
                    <div class="titulo"><h3>clorox ropa color <i>(500ml)</i></h3><hr>
                    <h4>Cat: Aseo para el hogar</h4></div><br>
                    <div class="descripción"><h5>Clorox ropa color, Producto con una fórmula exclusiva a base de Peróxido ideal para colores claros</h5><br></div>
                    <small class="tamaño">Añadir al carrito</small><br>
                    <small class="buy"><b>Cantidad</b></small>
                </div>
            </div>
